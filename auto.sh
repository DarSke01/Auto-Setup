...
#Variabel
Fetch=~/.file-sh/script/fetch.sh
Timeshisft=~/.file-sh/script/timeshift.sh
Full=~/.file-sh/script/full_scan.sh

MainP=~/.file-sh/script/Pacman/main.sh
Pacman=~/.file-sh/script/Pacman/pacman.sh
AUR=~/.file-sh/script/Pacman/aur.sh
SCANP=~/.file-sh/script/Pacman/scan.sh
CLEANP=~/.file-sh/script/Pacman/clean.sh
